...
export const Rating = ({ maxRating = 5, initialRating = 0, size = 24, onChange, starColor = '#423b9b', hoverColor = '#9d99f5', unratedColor = '#cfcff9', ratingTexts = defaultRatingTexts, readOnly = false, icon }) => {
