...
export const Toggle = ({ value, children, className = '', defaultSelected = false, outline = false, disabled = false, onChange, ...rest }) => {
    ...
    return (_jsx("button", { className: cn("rounded-md px-4 py-2 transition-all duration-200", getButtonStyles(), className), onClick: handleClick, disabled: disabled, ...rest, children: children }));
};
