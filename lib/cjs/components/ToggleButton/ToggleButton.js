...
export const ToggleButton = ({ value, children, className = '', ...rest }) => {
    ...
    return (_jsx("button", { className: cn("rounded-md px-4 py-2 transition-colors duration-200", getButtonStyles(), className), onClick: () => handleChange(value), disabled: disabled, ...rest, children: children }));
};
