...
export const ToggleButtonGroupProvider = ({ children, type, defaultValue = type === 'single' ? '' : [], onChange, outline = false, disabled = false }) => {
    ...
    return (_jsx(ToggleButtonGroupContext.Provider, { value: { type, selectedValues, handleChange, outline, disabled }, children: children }));
};
