...
export const DatePicker = ({ onChange, initialDates = [], isRange = false, shape = "circle", placeholder = 'Select your date', className = "", ...rest }) => {
    ...
    return (_jsxs("div", { className: 'relative', children: [_jsx("input", { type: 'text', className: cn('w-full rounded-md border text-primary-800 dark:text-primary-200 border-primary-500 px-4 py-2 bg-primary-200 dark:bg-primary-800 outline-none focus-visible:outlined', className), value: formatDateRange(selectedDates), onClick: () => setIsOpen(!isOpen), readOnly: true, placeholder: placeholder, ...rest }), isOpen && (_jsxs("div", { className: 'absolute p-4 left-0 top-full mt-2 rounded-md border border-primary-500 bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 shadow-lg', children: [_jsxs("div", { className: 'flex items-center justify-between py-2', children: [_jsx("button", { onClick: handlePrevMonth, className: cn('p-1 border border-primary-500/30 hover:bg-primary-200 dark:hover:bg-primary-800', shape === 'circle' ? 'rounded-full' : shape === 'rounded' ? 'rounded-md' : ''), children: _jsx(Left, {}) }), _jsxs("div", { className: 'flex flex-1 justify-center gap-3', children: [_jsxs(Dropdown, { children: [_jsx(DropdownAction, { className: 'mr-2 bg-transparent appearance-none text-center border-b border-dotted border-primary-800 dark:border-primary-200 outline-none cursor-pointer hover:bg-transparent text-primary-800 dark:text-primary-200 rounded-none p-0 ring-0', children: monthNames[currentDate.getMonth()] }), _jsx(DropdownContent, { children: _jsx(DropdownList, { children: monthNames.map((month, index) => (_jsx(DropdownItem, { className: `bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 hover:bg-primary-200 dark:hover:bg-primary-800 ${currentDate.getMonth() == index ? "bg-primary-200 dark:bg-primary-800" : ""}`, onClick: () => {
                                                        ...
                                                        }, children: month }, month))) }) })] }), _jsxs(Dropdown, { children: [_jsx(DropdownAction, { className: 'mr-2 bg-transparent appearance-none text-center border-b border-dotted border-primary-800 dark:border-primary-200 outline-none cursor-pointer hover:bg-transparent text-primary-800 dark:text-primary-200 rounded-none p-0 ring-0', children: currentDate.getFullYear() }), _jsx(DropdownContent, { className: 'overflow-y-auto [&::-webkit-scrollbar]:w-2\n  [&::-webkit-scrollbar-track]:bg-gray-100\n  [&::-webkit-scrollbar-thumb]:bg-gray-300\n  dark:[&::-webkit-scrollbar-track]:bg-neutral-700\n  dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500', style: { maxHeight: '300px' }, children: _jsx(DropdownList, { children: years.map((year) => (_jsx(DropdownItem, { className: `bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-200 hover:bg-primary-200 dark:hover:bg-primary-800`, activeClassName: "bg-primary-200 dark:bg-primary-800", onClick: () => {
