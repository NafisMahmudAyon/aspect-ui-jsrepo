...
type = 'info', duration = 3000, onClose, action }) => {
    ...
    return (_jsx("div", { className: `fixed bottom-4 right-4 rounded-md px-4 py-2 text-white ${getBackgroundColor()} shadow-lg transition-opacity duration-300`, children: _jsxs("div", { className: 'flex items-center justify-between', children: [_jsxs("div", { children: [_jsx("div", { className: 'font-medium', children: message }), description && ( // Render description if provided
                        _jsx("div", { className: 'mt-1 text-sm opacity-90', children: description }))] }), action && (_jsx("button", { onClick: action.onClick, className: 'ml-4 rounded-md bg-white px-2 py-1 text-sm font-medium text-black', children: action.label }))] }) }));
};
