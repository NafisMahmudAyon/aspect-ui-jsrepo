...
export const ToggleButtonGroupProvider: React.FC<ToggleButtonGroupProviderProps> = ({
  children,
  type,
  ...
  return (
    <ToggleButtonGroupContext.Provider value={{ type, selectedValues, handleChange }}>
      {children}
