...
export const Avatar: React.FC<AvatarProps> = ({
  ...
  return (
    <div
      className={`${styles} ${variantValue.styles} flex justify-center items-center size-12 rounded-full overflow-hidden`}
      {...(name && { title: name })}
      {...rest}
      onClick={onClick}
    >
      {src && (
        <img
          ...
          className={`${imageStyles} ${variantValue.imageStyles} aspect-square max-w-full h-auto object-cover `}
        />
      )}
