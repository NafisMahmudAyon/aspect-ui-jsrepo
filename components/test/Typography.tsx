...
const TypographyDemo = () => {
  return (
    <div>
      <Typography variant='display' className='bg-primary-100 text-primary-800 hover:bg-primary-200 hover:text-primary-900 dark:bg-primary-900 dark:text-primary-200 dark:hover:bg-primary-800 dark:hover:text-primary-100'>This is a heading 1</Typography>
