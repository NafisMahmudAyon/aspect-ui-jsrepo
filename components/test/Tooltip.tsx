import { Tooltip, TooltipAction, TooltipContent } from '@/app/src/components/Tooltip/Tooltip'
    ...
    <div>
      ...
      <div className="space-x-4">
        <Tooltip direction="right" showOnClick>
          ...
          <TooltipContent>
            <p className="text-body-5 font-medium text-black">Tooltips - Title here</p>
          </TooltipContent>
        </Tooltip>
